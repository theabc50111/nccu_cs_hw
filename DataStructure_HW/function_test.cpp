...
void test(string file_name_ct, string file_name_ave_path, string type_record){
...
int main(){
    if(NODE==10){
        test("dij_arr_ct.csv", "dij_arr_ap.csv", "dijkstra in array");
    }
